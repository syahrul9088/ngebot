...
const functionRegist = (realCookie, kelamin) => new Promise((resolve, reject) => {
    const params = new URLSearchParams;
    params.append('username', randomstring.generate(7));
    params.append('email', `${randomstring.generate(7)}@gmail.com`);
...
(async () => {
    ...
    try {
        ...
        const regist = await functionRegist(realCookie, kelamin)
